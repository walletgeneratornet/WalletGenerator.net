"ru": {
	...
	"footersupport": "Поддержать wallets.roro.by",
	...
	"defaultTitle": "wallets.roro.by - Универсальный генератор бумажных кошельков для Bitcoin и других криптовалют",
	...
	"securitychecklistrandomOK": "Ваш браузер способен генерировать криптографически случайные ключи",
	"securitychecklistrandomNOK": "Ваш браузер НЕ поддерживает функцию, которая важна для генерирования максимально безопасных случайных чисел. Пожалуйста, используйте более современный браузер.",
